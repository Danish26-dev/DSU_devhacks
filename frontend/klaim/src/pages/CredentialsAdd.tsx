  ...
  return (
    <div className="space-y-8">
      <PageHeading
        ...
        actions={
          <Button variant="ghost" className="rounded-none" onClick={() => void navigate("/app/credentials")}>
            Back to credentials
          </Button>
        }
      />
        ...
        <Panel accent>
          ...
          <div className="p-5">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <Button className="rounded-none" onClick={() => void navigate("/app/credentials")}>
                View credentials
              </Button>
              <Button variant="outline" className="rounded-none" onClick={() => void navigate("/app/dashboard")}>
                Back to overview
              </Button>
            </div>
          </div>
